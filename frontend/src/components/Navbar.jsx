        ...
        <>
            <nav className={`fixed 4 top-0 left-0 right-0 z-[100] transition-all duration-300 ${isScrolled ? 'bg-[#FAF9F6]/95 backdrop-blur-md shadow-md py-2' : 'bg-[#FAF9F6] py-3.5'}`}>
                ...
                <div className="flex items-center justify-end gap-x-2 xl:gap-x-3 shrink-0">
                        ...
                        <a href="https://appointment.mmpsrpc.in/" target="_blank" rel="noopener noreferrer" className="px-2.5 py-1.5 xl:px-3 xl:py-2 2xl:px-4 2xl:py-2.5 bg-white text-[#0D9488] border border-teal-100 shadow-sm font-sans font-semibold rounded-full hover:scale-105 active:scale-95 transition-all text-[9px] xl:text-[10px] 2xl:text-[11px] whitespace-nowrap uppercase tracking-[0.08em]">
                            Appointment
                        </a>
                    </div>
